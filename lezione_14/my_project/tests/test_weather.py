...
def test_check_weather1():
   assert check_weather(21.00) == "hot", ' temperature greater than 20 degrees must be consider hot'
...
def test_check_weather4():
   assert check_weather(13.00) == 'average', 'temperatures between 10 and 20 degree must be considered as average temperatures'

#failed because every def test_function() is considered as a single test
def test_check_weather5():
   assert check_weather(30.00) == 'hot', ' temperature greater than 20 degrees must be consider hot'
